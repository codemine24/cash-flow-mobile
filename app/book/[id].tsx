...
export default function BookDetailScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: book.data.name, headerBackTitle: "Books" }} />
      <ScreenContainer className="p-4 bg-background">
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
          {/* Header Card */}
          <View className="bg-surface rounded-xl p-6 mb-6 border border-border">
            <Text className="text-muted text-center mb-2 text-lg">Current Balance</Text>
            <Text
            ...
            <View className="flex-row gap-4">
              <View className="flex-1 bg-background rounded-lg p-3 border border-border items-center">
                ...
                <Text className="text-lg font-bold text-success">{formatCurrency(book.data.in)}</Text>
              </View>
              <View className="flex-1 bg-background rounded-lg p-3 border border-border items-center">
                <Text className="text-xs text-muted font-medium mb-1">Expenses</Text>
                <Text className="text-lg font-bold text-error">{formatCurrency(book.data.out)}</Text>
              </View>
            </View>
          </View>
